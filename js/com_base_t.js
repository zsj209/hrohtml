...
var clnrequestData = {_mt:"payrollTax.getTableHead",userid:"3",stype:"1"};//获取表头接口
var bnrequestData = {_mt:"payrollTax.getTableHead",userid:"3",stype:"2"};//获取按钮列表的接口 
var fieldquestData = {_mt:"payrollTax.getTableHead",userid:"3",stype:"3"};//获取新增页面字段接口
var clmrequestData={_mt:"payrollTaxation.selectDataByTaxation"};//获取数据的接口
var gdid="jq_pays_taxation";//显示数据的div
var addtb_div="pays_taxation_addinfoarea";//新增 修改 显示字段的div
var seldiv="pays_taxation";//根据id查询的divid
var updinterface="payrollTaxation.selectDataByIds";//修改时根据id获取数据的接口
var upinfointerface="payrollTaxation.updateData";//修改数据的接口
var ininfointerface="payrollTaxation.insertData";//新增数据的接口
var dlinfointerface="payrollTaxation.batchDeleteByid";//批量删除接口
var _mtnm="payrollTax";//根据id选择 框  获取jqGrid表头的街头前缀 后缀必须为 .getForIdsel
var bn_div="bn_pays_taxation";//按钮div的id
var None="None";//安全等级
var bnsuffix="_paystaxation";//按钮后缀
var pageid="#page_pays_taxation";//分页div
// 
